...
<form id="form"  class="w-full max-w-lg" action="{{ route('internships.update', ['internship' => $internship->id ]) }}" method="POST">
    ...
    <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
      ...
      <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="studentname">
         Student Name
        </label>
        <select class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " name="student_id" id="student_id">
      ...
      <div class="w-full md:w-auto px-3  mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('begindate') border-red-500 @enderror"  value="{{ old('begindate', $internship->begindate) }}" name="begindate" id="begindate"  type="date" placeholder="01-01-2021" required  >
      </div>
      ...
      <div class="w-full md:w-auto px-3  mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('enddate') border-red-500 @enderror"  value="{{ old('enddate', $internship->enddate) }}" name="enddate" id="enddate"  type="date" placeholder="?"  >
      </div>
