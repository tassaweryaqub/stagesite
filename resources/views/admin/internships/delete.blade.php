...
<form id="form"  class="w-full max-w-lg" action="{{ route('internships.update', ['internship' => $internship->id ]) }}" method="POST">
    ...
    <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
      ...
      <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
        ...
        <select class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " name="student_id" id="student_id" disabled>
