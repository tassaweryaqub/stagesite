    ...
    @csrf 
      ...
      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white @error('name') border-red-500 @enderror"
           name="name" id="name" value="{{ old('name') }}"  type="text" placeholder="StudentName" disabled>
      </div>
        ...
        <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
          ...
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white @error('review') border-red-500 @enderror"
               name="review" id="review" value="{{ old('review') }}"  type="text" placeholder="StudentReview" disabled>
          </div>
          ...
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white @error('rating') border-red-500 @enderror"
               name="rating" id="rating" value="{{ old('rating') }}"  type="number" placeholder="0...10" disabled >
          </div>
          ...
          <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
            ...
            <select class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " name="technic_id" id="technic_id" disabled>
          ...
          <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
            ...
            <select class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " name="school_id" id="school_id" disabled>
          ...
          <div class="w-full md:w-auto  px-3  mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="practicalteacher">
            ...
            <select class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " name="practicalteacher_id" id="practicalteacher_id" disabled>
                ...
                <option value="{{ $practicalteacher->id }}"
                    @if (old('practicalteacher_id') == $practicalteacher->id)
                    selected                 
                    @endif
                    >{{ $practicalteacher->description}}
                </option>    
